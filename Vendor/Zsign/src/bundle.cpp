...
bool ZBundle::GetObjectsToSign(const string& strFolder, jvalue& jvInfo)
{
	...
	const char* skipNestedBundles = getenv("ZSIGN_SKIP_NESTED_BUNDLES");
	bool bSkipNestedBundles = (NULL != skipNestedBundles && 0 == strcmp(skipNestedBundles, "1"));
